package org.opengis.cite.gmljp2.level1;

import java.io.IOException;
import java.net.URL;
import javax.xml.transform.Source;
import javax.xml.transform.dom.DOMSource;
import org.opengis.cite.gmljp2.ErrorMessage;
import org.opengis.cite.gmljp2.ErrorMessageKeys;
import org.opengis.cite.gmljp2.SuiteAttribute;
...
public class Capability1Tests {
     ...
     * {@link org.opengis.cite.gmljp2.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/gmljp2/rnc/atom.rnc");
