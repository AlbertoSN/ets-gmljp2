...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/gmljp2"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.gmljp2.TestNGController">

  <ctl:function name="tns:run-ets-gmljp2">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the gmljp2 ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:suite name="tns:ets-gmljp2-${version}">
     <ctl:title>Test suite ets-gmljp2</ctl:title>
   ...
   <ctl:test name="tns:Main">
	  ...
	  <ctl:code>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-gmljp2">
